...
$auth_users = $_SESSION[PFMT_SESSION_ID]['users'];
...
$directories_users = $_SESSION[PFMT_SESSION_ID]['directories'];
...
if ( !defined( 'PFMT_SESSION_ID')) {
    define('PFMT_SESSION_ID', 'filemanager');
}
...
if (isset($_SESSION[PFMT_SESSION_ID]['logged']) && !empty($directories_users[$_SESSION[PFMT_SESSION_ID]['logged']])) {
    $wd = fm_clean_path(dirname($_SERVER['PHP_SELF']));
    $root_url =  $root_url.$wd.DIRECTORY_SEPARATOR.$directories_users[$_SESSION[PFMT_SESSION_ID]['logged']].DIRECTORY_SEPARATOR;
}
    ...
    if (isset($_SESSION[PFMT_SESSION_ID]['logged'], $auth_users[$_SESSION[PFMT_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']])) {
                $_SESSION[PFMT_SESSION_ID]['logged'] = $_POST['fm_usr'];
...
// update root path
if ($use_auth && isset($_SESSION[PFMT_SESSION_ID]['logged'])) {
    $root_path = isset($directories_users[$_SESSION[PFMT_SESSION_ID]['logged']]) ? $directories_users[$_SESSION[PFMT_SESSION_ID]['logged']] : $root_path.'/'.$directories_users[$_SESSION[PFMT_SESSION_ID]['logged']];
}
...
define('FM_READONLY', $use_auth && !empty($readonly_users) && isset($_SESSION[PFMT_SESSION_ID]['logged']) && in_array($_SESSION[PFMT_SESSION_ID]['logged'], $readonly_users));
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                <p class="card-text">
                    <a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo FM_PATH ?>" class="float-right"><i class="fa fa-chevron-circle-left go-back"></i> <?php echo lng('Back')?></a>
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <p>
                        ...
                        <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>" class="btn btn-outline-primary"><i class="fa fa-times-circle"></i> <?php echo lng('Cancel') ?></a></b>
                    </p>
                </form>
            </div>
        </div>
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <p>
            <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1"><i class="fa fa-check-circle"></i> Copy</a></b> &nbsp;
            <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1&amp;move=1"><i class="fa fa-check-circle"></i> Move</a></b> &nbsp;
            <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-times-circle"></i> Cancel</a></b>
        </p>
        ...
        <ul class="folders break-word">
            ...
            if ($parent !== false) {
                ?>
                <li><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode($parent) ?>&amp;copy=<?php echo urlencode($copy) ?>"><i class="fa fa-chevron-circle-left"></i> ..</a></li>
                <?php
            }
            foreach ($folders as $f) {
                ?>
                <li>
                    <a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>&amp;copy=<?php echo urlencode($copy) ?>"><i class="fa fa-folder-o"></i> <?php echo fm_convert_win($f) ?></a></li>
                <?php
            }
            ?>
        </ul>
    ...
    <div class="col-md-8 offset-md-2 pt-3">
        <div class="card mb-2 <?php echo fm_get_theme(); ?>">
            <h6 class="card-header">
                ...
                <a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo FM_PATH ?>" class="float-right"><i class="fa fa-window-close"></i> <?php echo lng('Cancel')?></a>
            </h6>
            <div class="card-body">
    ...
    <div class="row">
        <div class="col-12">
            <?php if(!$quickView) { ?>
                ...
                <p class="break-word">
                    Full path: <?php echo str_replace ( $root_url, "/" , fm_enc(fm_convert_win($file_path))) ?><br>
                    File
                ...
                <p>
                    <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;dl=<?php echo urlencode($file) ?>"><i class="fa fa-cloud-download"></i> <?php echo lng('Download') ?></a></b> &nbsp;
                    ...
                    if (!FM_READONLY && ($is_zip || $is_gzip) && $filenames !== false) {
                        ...
                        ?>
                        <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;unzip=<?php echo urlencode($file) ?>"><i class="fa fa-check-circle"></i> <?php echo lng('UnZip') ?></a></b> &nbsp;
                        <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;unzip=<?php echo urlencode($file) ?>&amp;tofolder=1" title="UnZip to <?php echo fm_enc($zip_name) ?>"><i class="fa fa-check-circle"></i>
                                <?php echo lng('UnZipToFolder') ?></a></b> &nbsp;
                        <?php
                    }
                    if ($is_text && !FM_READONLY) {
                        ?>
                        <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>" class="edit-file"><i class="fa fa-pencil-square"></i> <?php echo lng('Edit') ?>
                            </a></b> &nbsp;
                        <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&env=ace"
                              class="edit-file"><i class="fa fa-pencil-square-o"></i> <?php echo lng('AdvancedEditor') ?>
                            </a></b> &nbsp;
                    <?php } ?>
                    <b><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-chevron-circle-left go-back"></i> <?php echo lng('Back') ?></a></b>
                </p>
                <?php
            }
            if($is_onlineViewer) {
    ...
    <div class="path">
        <div class="row">
            ...
            <div class="edit-file-actions col-xs-12 col-sm-7 col-lg-6 text-right pt-1">
                <a title="Back" class="btn btn-sm btn-outline-primary" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;view=<?php echo urlencode($file) ?>"><i class="fa fa-reply-all"></i> <?php echo lng('Back') ?></a>
                ...
                <?php if ($is_text) { ?>
                    <?php if ($isNormalEditor) { ?>
                        <a title="Advanced" class="btn btn-sm btn-outline-primary" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&amp;env=ace"><i class="fa fa-pencil-square-o"></i> <?php echo lng('AdvancedEditor') ?></a>
                    ...
                    <?php } else { ?>
                        <a title="Plain Editor" class="btn btn-sm btn-outline-primary" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>"><i class="fa fa-text-height"></i> <?php echo lng('NormalEditor') ?></a>
...
<form action="" method="post" class="pt-3">
        ...
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            if ($parent !== false) {
                ...
                <tr><?php if (!FM_READONLY): ?>
                    ...
                    <td class="border-0"><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode($parent) ?>"><i class="fa fa-chevron-circle-left go-back"></i> ..</a></td>
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td>
                        <div class="filename"><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="<?php echo $img ?>"></i> <?php echo fm_convert_win(fm_enc($f)) ?>
                    ...
                    <?php if (!FM_IS_WIN && !$hide_Cols): ?>
                        <td><?php if (!FM_READONLY): ?><a title="Change Permissions" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>"><?php echo $perms ?></a><?php else: ?><?php echo $perms ?><?php endif; ?>
                        </td>
                        <td><?php echo $owner['name'] . ':' . $group['name'] ?></td>
                    <?php endif; ?>
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                            <a title="<?php echo lng('Delete')?>" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;del=<?php echo urlencode($f) ?>" onclick="return confirm('<?php echo lng('Delete').' '.lng('Folder').'?'; ?>\n \n ( <?php echo urlencode($f) ?> )');"> <i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            ...
                            <a title="<?php echo lng('CopyTo')?>..." href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=&amp;copy=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="fa fa-files-o" aria-hidden="true"></i></a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php
            ...
            foreach ($files as $f) {
                ...
                $filesize = fm_get_filesize($filesize_raw);
                $filelink = '?Resource=fileManagerPlugin&p=' . urlencode(FM_PATH) . '&amp;view=' . urlencode($f);
                ...
                <tr>
                    ...
                    <?php if (!FM_IS_WIN && !$hide_Cols): ?>
                        <td><?php if (!FM_READONLY): ?><a title="<?php echo 'Change Permissions' ?>" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>"><?php echo $perms ?></a><?php else: ?><?php echo $perms ?><?php endif; ?>
                        </td>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php if (!FM_READONLY): ?>
                            <a title="<?php echo lng('Delete') ?>" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;del=<?php echo urlencode($f) ?>" onclick="return confirm('<?php echo lng('Delete').' '.lng('File').'?'; ?>\n \n ( <?php echo urlencode($f) ?> )');"> <i class="fa fa-trash-o"></i></a>
                            ...
                            <a title="<?php echo lng('CopyTo') ?>..."
                               href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="fa fa-files-o"></i></a>
                        <?php endif; ?>
                        <a title="<?php echo lng('Download') ?>" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;dl=<?php echo urlencode($f) ?>"><i class="fa fa-download"></i></a>
                    </td>
                </tr>
                <?php
                flush();
    ...
    <div class="row">
        ...
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted"></a></div>
        <?php endif; ?>
    </div>
...
{
    $_SESSION[PFMT_SESSION_ID]['message'] = $msg;
    $_SESSION[PFMT_SESSION_ID]['status'] = $status;
}
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = "<a href='?Resource=fileManagerPlugin&p='><i class='fa fa-home' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
            ...
            if ($path != '') {
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    $array[] = "<a href='?Resource=fileManagerPlugin&p={$parent_enc}'>" . fm_enc(fm_convert_win($exploded[$i])) . "</a>";
                }
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <?php if (!FM_READONLY): ?>
                    <li class="nav-item">
                        <a title="<?php echo lng('Upload') ?>" class="nav-link" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i> <?php echo lng('Upload') ?></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item avatar dropdown">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-user-circle"></i> <?php if(isset($_SESSION[PFMT_SESSION_ID]['logged'])) { echo $_SESSION[PFMT_SESSION_ID]['logged']; } ?></a>
                        <div class="dropdown-menu dropdown-menu-right <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <?php if (!FM_READONLY): ?>
                            <a title="<?php echo lng('Settings') ?>" class="dropdown-item nav-link" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;settings=1"><i class="fa fa-cog" aria-hidden="true"></i> <?php echo lng('Settings') ?></a>
                            <?php endif ?>
                            <a title="<?php echo lng('Help') ?>" class="dropdown-item nav-link" href="<?php echo htmlspecialchars(FM_SELF_URL);?>p=<?php echo urlencode(FM_PATH) ?>&amp;help=2"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo lng('Help') ?></a>
...
{
    if (isset($_SESSION[PFMT_SESSION_ID]['message'])) {
        $class = isset($_SESSION[PFMT_SESSION_ID]['status']) ? $_SESSION[PFMT_SESSION_ID]['status'] : 'ok';
        echo '<p class="message ' . $class . '">' . $_SESSION[PFMT_SESSION_ID]['message'] . '</p>';
        unset($_SESSION[PFMT_SESSION_ID]['message']);
        unset($_SESSION[PFMT_SESSION_ID]['status']);
    }
}
...
<head>
    ...
    <?php endif; ?>
    <style>
        body { font-size:14px;color:#222;background:#FFFFFF; }
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            body.theme-dark { background-color: #FFFFFF; }
...
<script>
    ...
    function newfolder(e) {
        ...
        null !== t && "" !== t && n && (window.location.hash = "#", window.location.search = "?Resource=fileManagerPlugin&p=" + encodeURIComponent(e) + "&new=" + encodeURIComponent(t) + "&type=" + encodeURIComponent(n))
    }
    function rename(e, t) {var n = prompt("New name", t);null !== n && "" !== n && n != t && (window.location.search = "?Resource=fileManagerPlugin&p=" + encodeURIComponent(e) + "&ren=" + encodeURIComponent(t) + "&to=" + encodeURIComponent(n))}
    ...
    function search_template(data) {
        ...
        $.each(data, function (key, val) {
            response += `<li><a href="<?php echo htmlspecialchars(FM_SELF_URL);?>?Resource=fileManagerPlugin&p=${val.path}&view=${val.name}">${val.path}/${val.name}</a></li>`;
        });
        return response;
    }
    //search
